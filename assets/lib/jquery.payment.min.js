(function () {
    ...
    (t =
        window.jQuery ||
        window.Zepto ||
        window.$), (t.payment = {}), (t.payment.fn = {}), (t.fn.payment = function () {
            var e, n;
            return (n = arguments[0]), (e =
                2 <= arguments.length ? S.call(arguments, 1) : []), t.payment.fn[n].apply(
                    this,
                    e
                );
            ...
            for (
                ...
                (e = n[o]), (e = parseInt(e, 10)), (r = !r) && (e *= 2), e > 9 &&
                    (e -= 9), (a += e);
            return a % 10 === 0;
        }), (h = function (t) {
            var e;
            ...
            return (i = e.val()), e.val(t), null !== r && e.is(":focus")
                ? (
            ...
            var e, n, r, a, o, i, l, u;
            for (
                null == t && (t = ""), r = "０１２３４５６７８９", a = "0123456789", i =
                "", e = t.split(""), l = 0, u = e.length;
                u > l;
                l++
            )
            ...
            var r, a, o, i, l, u, s;
            return (o = String.fromCharCode(n.which)), !/^\d+$/.test(o) ||
                (
                    (r = t(n.currentTarget)),
                    (s = r.val()),
                    (a = e(s + o)),
            ...
            var n, r;
            return (n = t(e.currentTarget)), (r = n.val()), 8 !== e.which ||
                (null != n.prop("selectionStart") && n.prop("selectionStart") !== r.length)
                ? void 0
                : /\d\s$/.test(r)
                    ? (
                        e.preventDefault(),
            ...
            var n, r, a;
            return (r = String.fromCharCode(e.which)), /^\d+$/.test(r)
                ? (
                    (n = t(e.currentTarget)),
                    (a = n.val() + r),
                    /^\d$/.test(a) && "0" !== a && "1" !== a
                            ...
                            ? (
                                ...
                                setTimeout(function () {
                                    ...
                                    return (t = parseInt(
                                        a[0],
                                        10
                                    )), (e = parseInt(a[1], 10)), e > 2 && 0 !== t ? n.val("0" + t + " / " + e) : n.val("" + a + " / ");
                                })
                            )
                            : void 0
                )
            ...
            var n, r, a;
            return (a = String.fromCharCode(e.which)), "/" === a || " " === a
                ? (
                    (n = t(e.currentTarget)),
                    (r = n.val()),
            ...
            var r, a, o, i;
            return (r = t(n.currentTarget)), (o = String.fromCharCode(
                n.which
            )), /^\d+$/.test(o) && !h(r)
                    ? (
            ...
            var n, r, a;
            return (n = t(e.currentTarget)), (r = String.fromCharCode(
                e.which
            )), /^\d+$/.test(r) && !h(n)
                    ? (
                        (a = n.val() + r),
            ...
            var n, a, o, i, l;
            return (n = t(e.currentTarget)), (l = n.val()), (i =
                t.payment.cardType(l) || "unknown"), n.hasClass(i)
                    ? void 0
                    : (
                        (a = (function () {
                            var t, e, n;
            ...
            return this.on("keypress", w), this.on("keypress", y), this.on(
                "paste",
                g
            ), this.on("change", g), this.on("input", g), this;
        }), (t.payment.fn.formatCardExpiry = function () {
            return this.on("keypress", w), this.on("keypress", T), this.on(
                "keypress",
                u
            ), this.on("keypress", c), this.on("keypress", s), this.on(
                "keydown",
                i
            ), this.on("change", f), this.on("input", f), this;
        }), (t.payment.fn.formatCardNumber = function () {
            return this.on("keypress", w), this.on("keypress", C), this.on(
                "keypress",
                l
            ), this.on("keydown", o), this.on("keyup", D), this.on("paste", v), this.on(
                "change",
                v
            ), this.on("input", v), this.on("input", D), this;
        }), (t.payment.fn.restrictNumeric = function () {
            return this.on("keypress", w), this.on("paste", d), this.on(
                "change",
                d
            ...
            var e, n, r, a;
            return (a = t.split(/[\s\/]+/, 2)), (e = a[0]), (r = a[1]), 2 ===
                (null != r ? r.length : void 0) &&
                /^\d+$/.test(r) &&
                (
                    (n = new Date().getFullYear()),
                    (n = n.toString().slice(0, 2)),
                    (r = n + r)
                ), (e = parseInt(e, 10)), (r = parseInt(r, 10)), { month: e, year: r };
        }), (t.payment.validateCardNumber = function (t) {
            var n, r;
            return (t = (t + "").replace(/\s+|-/g, "")), /^\d+$/.test(t)
                ? (
                    (n = e(t)),
                    n
                        ? (
            ...
            var r, a, o, i;
            return (n = n.replace(/\D/g, "")), (r = e(n))
                ? (
                    (o = r.length[r.length.length - 1]),
                    (n = n.slice(0, o)),
                    r.format.global
                        ? null != (i = n.match(r.format)) ? i.join(" ") : void 0
                        : (
                            (a = r.format.exec(n)),
                            null != a
                                ? (
