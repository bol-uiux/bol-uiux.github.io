    ...
    $.fn.cashierDepositForm = function () {
...

        {
            ...
            depositOptionButtons.on("click", function () {
                ...
                $(depositAmountInput).trigger("blur");
                updateButtonState();
            });
            ...
            function displayFee() {
                ...
                var feeFromTotal = feeAmount * value;
                var total = parseFloat(value) + parseFloat(feeFromTotal);
            ...
            //implementation for validation and highlight the submit button
            function updateButtonState() {
                ...
                $("#DivCCAmount").removeClass("has-danger");
            }
