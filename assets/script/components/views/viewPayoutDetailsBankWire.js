...
$(document).ready(function() {
    ...
    var mobileDisclaimerBtn = document.getElementById('mobile_warning_confirm_btn');
    ...
    var handleMobileDisclaimerBtn = function(e) {
        var mobileWarning = document.getElementById('monygram_mobile_warning');
        var appBody = document.getElementById('app_body');
        mobileWarning.style.display = "none";
        appBody.style.display = "block";
    }

    mobileDisclaimerBtn.addEventListener('click', handleMobileDisclaimerBtn, false);
});
