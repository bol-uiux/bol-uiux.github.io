function checkForm(form) {
    ...
    if (!valid_address) {
        ...
        jcount++;
		jmsgText = jmsgText + (jcount ==1 ? "Neteller Address" : ", Neteller Address");
	...
	if (jcount > 0) {
		var error_confg = {
			title			: "Netller Address Verification",
			corrections		: ["The following form fields are either invalid or missing. Please review. <br> <strong>Neteller Address</strong> "]
		};
