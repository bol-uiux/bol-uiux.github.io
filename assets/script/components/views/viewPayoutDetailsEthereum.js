function checkForm(form) {
    ...
    if (!valid_address) {
        ...
        jcount++;
		jmsgText=jmsgText + (jcount ==1 ? "Ethereum Address" : ", Ethereum Address");
	...
	if (jcount > 0) {
		...
		var error_confg = {
			title			: "Ethereum Address Verification",
			corrections		: ["The following form fields are either invalid Or missing. Please review. <br> <strong>Ethereum Address</strong> "]
		};
